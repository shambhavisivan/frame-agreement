...
export function useGetAttachmentOriginalItems(
	...
	const [attachmentOriginalItems, setattachmentOriginalItems] = useState<AttachmentOriginalItems>(
	...
	useEffect(() => {
		if (
			...
			setattachmentOriginalItems(faAttachment);
		}
	}, [
