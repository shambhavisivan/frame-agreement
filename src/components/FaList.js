        ...
        return (
            <div className="fa-list"> 
                    ...
                    <div className="fa-list-header-compartment">
                        <div className="header-row">
                            <div className="logo-container">
                                ...
                                <i className="cloudsense-logo"></i>
                            </div>
                            <div className="action-container">
                                <button className="slds-button slds-button--brand link-button"><Link to='/agreement'>Add new Agreement</Link></button>
                            </div>
                        </div>
                ...
                <div className="fa-list-body">
                      {Object.values(this.props.frameAgreements).filter(fa => {
                        if (this.state.searchTerm) {
                            if (fa.csconta__Agreement_Name__c.toLowerCase().includes(this.state.searchTerm.toLowerCase())) {
                                return true;
                            } else {
                                return false;
                            }
                         ...
                         return (
                            <FrameAgreementRow key={fa.Id} agreement={fa}/>
                          );
                        })}
                </div>
            </div>
